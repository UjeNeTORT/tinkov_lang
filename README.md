...
Поэтому можно провести ряд оптимизаций над AST, которые не поменяют логику работы программы, но при этом облегчат жизнь бэкенду.
...
За точность вычислений отвечает константа, в данном случае поправка составляет $10^2 = 100$
